...
var _kirchner$form_validation$MainWithValidations_ops = _kirchner$form_validation$MainWithValidations_ops || {};
_kirchner$form_validation$MainWithValidations_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _kirchner$form_validation$MainWithValidations$decodeSignUpResponse = _elm_lang$core$Json_Decode$fail('TODO: decode the actual response');
var _kirchner$form_validation$MainWithValidations$signUpParams = function (model) {
	var _p0 = {
		ctor: '_Tuple5',
		_0: _kirchner$form_validation$Validate$validValue(model.username),
		_1: _kirchner$form_validation$Validate$validValue(model.nickname),
		_2: _kirchner$form_validation$Validate$validValue(model.email),
		_3: _kirchner$form_validation$Validate$validValue(model.password),
		_4: _kirchner$form_validation$Validate$validValue(model.passwordCopy)
	};
	if ((((((_p0.ctor === '_Tuple5') && (_p0._0.ctor === 'Just')) && (_p0._1.ctor === 'Just')) && (_p0._2.ctor === 'Just')) && (_p0._3.ctor === 'Just')) && (_p0._4.ctor === 'Just')) {
		return _elm_lang$core$Maybe$Just(
			{username: _p0._0._0, nickname: _p0._1._0, email: _p0._2._0, password: _p0._3._0});
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _kirchner$form_validation$MainWithValidations$decodeValidationErrors = A2(
	_elm_lang$core$Json_Decode$map,
	_elm_lang$core$Set$fromList,
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string));
var _kirchner$form_validation$MainWithValidations$init = {
	ctor: '_Tuple2',
	_0: {
...
var _kirchner$form_validation$MainWithValidations$SignUpParams = F4(
	function (a, b, c, d) {
		return {username: a, nickname: b, email: c, password: d};
	});
var _kirchner$form_validation$MainWithValidations$WelcomeMessage = function (a) {
	return {ctor: 'WelcomeMessage', _0: a};
};
var _kirchner$form_validation$MainWithValidations$signUp = function (model) {
	var _p1 = _kirchner$form_validation$MainWithValidations$signUpParams(model);
	if (_p1.ctor === 'Just') {
			...
			_elm_lang$core$Json_Encode$object(
				A2(
					...
					_elm_lang$core$Basics$identity,
					{
						...
						_0: _elm_lang$core$Maybe$Just(
							A2(
								_kirchner$form_validation$MainWithValidations_ops['=>'],
								'username',
								_elm_lang$core$Json_Encode$string(_p1._0.username))),
						_1: {
							ctor: '::',
							_0: A2(
								...
								function (nickname) {
									return A2(
										_kirchner$form_validation$MainWithValidations_ops['=>'],
										'nickname',
										_elm_lang$core$Json_Encode$string(nickname));
								},
								_p1._0.nickname),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Maybe$Just(
									A2(
										_kirchner$form_validation$MainWithValidations_ops['=>'],
										'email',
										_elm_lang$core$Json_Encode$string(_p1._0.email))),
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Maybe$Just(
										A2(
											_kirchner$form_validation$MainWithValidations_ops['=>'],
											'password',
											_elm_lang$core$Json_Encode$string(_p1._0.password))),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		return A2(
			...
			_kirchner$form_validation$MainWithValidations$WelcomeMessage,
			A3(_elm_lang$http$Http$post, '/signup', body, _kirchner$form_validation$MainWithValidations$decodeSignUpResponse));
	} else {
		return _elm_lang$core$Platform_Cmd$none;
	}
};
var _kirchner$form_validation$MainWithValidations$SignUp = {ctor: 'SignUp'};
var _kirchner$form_validation$MainWithValidations$Reset = {ctor: 'Reset'};
var _kirchner$form_validation$MainWithValidations$AddUsernameValidationErrors = function (a) {
	return {ctor: 'AddUsernameValidationErrors', _0: a};
};
var _kirchner$form_validation$MainWithValidations$validateUsername = function (username) {
	var body = _elm_lang$http$Http$jsonBody(
		_elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
	...
	return A2(
		_elm_lang$http$Http$send,
		_kirchner$form_validation$MainWithValidations$AddUsernameValidationErrors,
		A3(_elm_lang$http$Http$post, '/validate', body, _kirchner$form_validation$MainWithValidations$decodeValidationErrors));
};
var _kirchner$form_validation$MainWithValidations$validateModel = function (model) {
	var username = A2(
		_kirchner$form_validation$Validate$consistsOfLetters,
		'The username must consist of letters only.',
		A2(_kirchner$form_validation$Validate$isNotEmpty, 'The username must not be empty.', model.username));
	var password = A3(
		_kirchner$form_validation$Validate$atLeast,
		6,
		'The password must contain at least 6 characters.',
		A2(_kirchner$form_validation$Validate$isNotEmpty, 'You must provide a password.', model.password));
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			model,
			{
				username: username,
				nickname: A2(
					_kirchner$form_validation$Validate$maybe,
					_kirchner$form_validation$Validate$consistsOfLetters('The nickname must consist of letters only.'),
					model.nickname),
				email: A2(
		...
		_1: function () {
			...
			if (_p2.ctor === 'Nothing') {
				...
				return _kirchner$form_validation$MainWithValidations$validateUsername(_p2._0);
			}
		}()
	};
};
var _kirchner$form_validation$MainWithValidations$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'SetUsername':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							username: _kirchner$form_validation$Validate$unchecked(_p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetNickname':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							nickname: (!_elm_lang$core$Native_Utils.eq(_p4, '')) ? _kirchner$form_validation$Validate$unchecked(
								_elm_lang$core$Maybe$Just(_p4)) : _kirchner$form_validation$Validate$valid(_elm_lang$core$Maybe$Nothing)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetEmail':
			...
			case 'SetPassword':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							password: _kirchner$form_validation$Validate$unchecked(_p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetPasswordCopy':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							passwordCopy: _kirchner$form_validation$Validate$unchecked(_p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ValidateForm':
				return _kirchner$form_validation$MainWithValidations$validateModel(model);
			case 'AddUsernameValidationErrors':
				var _p5 = _p3._0;
				if (_p5.ctor === 'Err') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								username: A2(_kirchner$form_validation$Validate$addErrors, _p5._0, model.username)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'Reset':
				return _kirchner$form_validation$MainWithValidations$init;
			case 'SignUp':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _kirchner$form_validation$MainWithValidations$signUp(model)
				};
			default:
				var _p6 = _p3._0;
				if (_p6.ctor === 'Err') {
					var _p7 = A2(_elm_lang$core$Debug$log, 'something went wrong', _p6._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p8 = A2(_elm_lang$core$Debug$log, 'message', _p6._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
		}
	});
var _kirchner$form_validation$MainWithValidations$ValidateForm = {ctor: 'ValidateForm'};
var _kirchner$form_validation$MainWithValidations$viewInput = F4(
	function (type_, label, onInput, value) {
		var id = _elm_lang$core$String$fromList(
			A2(
		...
		var viewErrors = function () {
			var _p9 = _kirchner$form_validation$Validate$errors(value);
			if (_p9.ctor === 'Nothing') {
				return {ctor: '[]'};
			} else {
				return {
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							viewError,
							_elm_lang$core$Set$toList(_p9._0))),
					_1: {ctor: '[]'}
				};
			}
		}();
			...
			_elm_lang$core$List$concat(
				{
					...
					_1: {
						...
						_0: (!_elm_lang$core$Native_Utils.eq(
							_kirchner$form_validation$Validate$validValue(value),
							_elm_lang$core$Maybe$Nothing)) ? {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('has-success'),
							_1: {ctor: '[]'}
						} : ((!_elm_lang$core$Native_Utils.eq(
							_kirchner$form_validation$Validate$errors(value),
							_elm_lang$core$Maybe$Nothing)) ? {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('has-error'),
							_1: {ctor: '[]'}
						} : {ctor: '[]'}),
						_1: {ctor: '[]'}
					}
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onBlur(_kirchner$form_validation$MainWithValidations$ValidateForm),
															_1: {ctor: '[]'}
														}
													}
												}
...
var _kirchner$form_validation$MainWithValidations$SetPasswordCopy = function (a) {
	return {ctor: 'SetPasswordCopy', _0: a};
};
...
var _kirchner$form_validation$MainWithValidations$SetNickname = function (a) {
	return {ctor: 'SetNickname', _0: a};
};
var _kirchner$form_validation$MainWithValidations$SetUsername = function (a) {
	return {ctor: 'SetUsername', _0: a};
};
var _kirchner$form_validation$MainWithValidations$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$form,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col-sm-offset-2'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('col-sm-8'),
							_1: {ctor: '[]'}
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Join our service!'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A4(_kirchner$form_validation$MainWithValidations$viewInput, 'text', '* Username', _kirchner$form_validation$MainWithValidations$SetUsername, model.username),
						_1: {
							ctor: '::',
							_0: A4(
								...
								'text',
								'Nickname',
								_kirchner$form_validation$MainWithValidations$SetNickname,
								A2(
									_kirchner$form_validation$Validate$map,
...
var _kirchner$form_validation$MainWithValidations$main = _elm_lang$html$Html$program(
	{
		init: _kirchner$form_validation$MainWithValidations$init,
		update: _kirchner$form_validation$MainWithValidations$update,
		subscriptions: function (_p10) {
			return _elm_lang$core$Platform_Sub$none;
		},
		view: _kirchner$form_validation$MainWithValidations$view
	})();
